...
| [qa-test-engineer](qa-test-engineer.md) | Tests nach `docs/reference/testing-plan.md` (Vitest/jsdom/Playwright) |
| [docs-agent](docs-agent.md) | `README.md`, `docs/`, `memory/`, `logs/` synchron halten |
...
- Sprache der Doku: Deutsch (Ausnahmen: `docs/reference/testing-plan.md` und `docs/reference/product-vision.md` sind Englisch).
